    ...
    public class ConversationsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Conversation != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Conversation'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ImportedDate")] Conversation conversation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ImportedDate")] Conversation conversation)
        {
